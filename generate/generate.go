...
// Generate menjalankan seluruh proses untuk menghasilkan dan menampilkan NFT
func Generate() error {
	...
	// Membaca kembali metadata JSON
	metadataJSON, err := os.ReadFile(metadataPath)
	if err != nil {
		return err
	}

	// Menghitung hash SHA512 dari metadata
...
func displayNFT(nftPath, metadataPath string) error {
	...
	fmt.Println("This machine belongs to you!")
